...
export async function GET() {
  ...
  return Response.json({
    ...
    modules: { marketData: "READY", macro: "READY", brains: "READY", conflicts: "READY", aiArbiter: openaiReady ? "READY" : "WAITING_SECRET", execution: liveEnabled ? "READY" : "SAFE_LOCKED", guardian: "READY", ledger: "READY", telegram: telegramReady ? "READY" : "WAITING_SECRET", replay: "READY" },
